...
// pull price and tax from each object
// multiply price and tax
...
let bobPurchases = purchases.filter(owner => owner.owner === 'Bob')

console.log(bobPurchases)

let bobsTotal = bobPurchases.reduce((acc, element, index, array) =>
